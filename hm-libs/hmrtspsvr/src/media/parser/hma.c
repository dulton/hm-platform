 ...
 * such as hm-mss, hm-proxy-server etc.
 *
 * */
...
static const MediaParserInfo info =			/* HM Audio Parser */
{
    "HMA",
    MP_audio
};
...
static int hma_init(Track *track)
{
...
static int hma_parse(Track *tr, uint8_t *data, size_t len)
{
/*
...
static void hma_uninit(Track *tr)
{
}


FNC_LIB_MEDIAPARSER(hma);
