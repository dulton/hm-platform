...
create_xml_head(XmlTreeNode *xml_tree, const char *message_type)
{
	...
	//xml root
	tree_node = (XmlTreeNode*)hm_xml_alloc(sizeof(XmlTreeNode));
	...
	//xml root attr
	node_attr = (XmlTreeAttr*)hm_xml_alloc(sizeof(XmlTreeAttr));
	...
	void *contact, ContactType type)
{
	...
	{
		child_node = (XmlTreeNode*)hm_xml_alloc(sizeof(XmlTreeNode));
		...
		switch (type)
		{
			...
			case CONTACT_STRING:
                ...
                else
                {
    			    ...
    			    tree_node->element.extend_contact = hm_xml_alloc(size);
	...
	void *contact, ContactType type)
{
	...
	{
		brother_node = (XmlTreeNode*)hm_xml_alloc(sizeof(XmlTreeNode));
		...
		*tree_node = brother_node;
		...
		switch (type)
		{
			...
			case CONTACT_STRING:
                ...
                {
                    size = sizeof(int)+len+1;/*head+body+end*/
    			    brother_node->element.extend_contact = hm_xml_alloc(size);
