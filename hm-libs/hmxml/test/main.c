...
/*static void test_get_info(int cmd_type, const char *path)
{
	...
	request = (Request*)hm_xml_alloc(sizeof(*request));
	...
	hm_xml_dealloc(request, sizeof(*request));
...
static void test_set_result(int cmd_type, const char *path)
{
	...
	result = (Result*)hm_xml_alloc(sizeof(*result));
	...
	hm_xml_dealloc(result, sizeof(*result));
...
static void test_register_request()
{
	...
	reg_request = (RegisterRequestPacket*)hm_xml_alloc(sizeof(*reg_request));
	...
	hm_xml_dealloc(reg_request, sizeof(*reg_request));
...
static void test_register_response()
{
	...
	reg_response = (RegisterResponsePacket*)hm_xml_alloc(sizeof(*reg_response));
	...
	hm_xml_dealloc(reg_response, sizeof(*reg_response));
...
static void test_heart_beat_request()
{
	...
	pu_heart = (HeartBeatRequestPacket*)hm_xml_alloc(sizeof(*pu_heart));
	...
	hm_xml_dealloc(pu_heart, sizeof(*pu_heart));
...
static void test_heart_beat_response()
{
	...
	hrt_beat_resp = (HeartBeatResponsePacket*)hm_xml_alloc(sizeof(*hrt_beat_resp));
	...
	hm_xml_dealloc(hrt_beat_resp, sizeof(*hrt_beat_resp));
...
static void test_change_dispatch_request()
{
	...
	change_disp = (ChangeDispatchPacket*)hm_xml_alloc(sizeof(*change_disp));
	...
	hm_xml_dealloc(change_disp, sizeof(*change_disp));
...
static void test_device_info_response()
{
	...
	dev_info = (DeviceInfoPacket*)hm_xml_alloc(sizeof(*dev_info));
	...
	hm_xml_dealloc(dev_info, sizeof(*dev_info));
...
static void test_device_ntp_info_response()
{
	...
	ntp_info = (DeviceNTPInfoPacket*)hm_xml_alloc(sizeof(*ntp_info));
	...
	hm_xml_dealloc(ntp_info, sizeof(*ntp_info));
...
static void test_set_device_time()
{
	...
	dev_time = (DeviceTimePacket*)hm_xml_alloc(sizeof(*dev_time));
	...
	hm_xml_dealloc(dev_time, sizeof(*dev_time));
...
static void test_platform_info_response()
{
	...
	pltf_info = (PlatformInfoPacket*)hm_xml_alloc(sizeof(*pltf_info));
	...
	hm_xml_dealloc(pltf_info, sizeof(*pltf_info));
...
static void test_network_info_response()
{
	...
	net_info = (NetworkInfoPacket*)hm_xml_alloc(sizeof(*net_info));
	...
	hm_xml_dealloc(net_info, sizeof(*net_info));
...
static void test_pppoe_info_response()
{
	...
	pppoe_info = (PPPOEInfoPacket*)hm_xml_alloc(sizeof(*pppoe_info));
	...
	hm_xml_dealloc(pppoe_info, sizeof(*pppoe_info));
...
static void test_disk_info_response()
{
	...
	disk_info = (DeviceDiskInfoPacket*)hm_xml_alloc(sizeof(*disk_info));
	...
	hm_xml_dealloc(disk_info, sizeof(*disk_info));
...
static void test_submit_alarm_request()
{
	...
	sub_alarm = (SubmitAlarmPacket*)hm_xml_alloc(sizeof(*sub_alarm));
	...
	hm_xml_dealloc(sub_alarm, sizeof(*sub_alarm));
...
static void test_get_media_url_response()
{
	...
	media_url = (MediaUrlPacket*)hm_xml_alloc(sizeof(*media_url));
	...
	hm_xml_dealloc(media_url, sizeof(*media_url));
...
static void test_user_list_info()
{
	...
	user_list.count = 2;
	user_list.user_info = (struct __UserInfo *)hm_xml_alloc(user_list.count * sizeof(struct __UserInfo));
	...
	hm_xml_dealloc(user_list.user_info, user_list.count * sizeof(struct __UserInfo));
	jpf_xml_msg_destroy_2(msg);
	printf("return: %d.buf: %s\n", ret, buf);
...
static void test_device_list_info()
{
	...
	device_list.count = 2;
	device_list.device_info = (struct _prx_device_info *)hm_xml_alloc(device_list.count * sizeof(struct _prx_device_info));
	...
	hm_xml_dealloc(device_list.device_info, device_list.count * sizeof(struct _prx_device_info));
	jpf_xml_msg_destroy_2(msg);
	printf("return: %d.buf: %s\n", ret, buf);
...
static void test_factory_list_info()
{
	...
	/*fct_list.count = 2;
	fct_list.factory = (struct _prx_factory_info *)hm_xml_alloc(fct_list.count * sizeof(struct _prx_factory_info));
	...
	hm_xml_dealloc(fct_list.factory, fct_list.count * sizeof(struct _prx_factory_info));
	jpf_xml_msg_destroy_2(msg);
	printf("return: %d.buf: %s\n", ret, buf);*/
...
static void test_get_device_info_result()
{
	...
	page_dev.dev_info= (struct _prx_device_info*)
		hm_xml_alloc(sizeof(struct _prx_device_info)*2);
	...
	hm_xml_dealloc(page_dev.dev_info, sizeof(struct _prx_device_info)*2);
	jpf_xml_msg_destroy_2(msg);
	printf("return: %d.buf: %s\n", ret, buf);
...
static void test_get_all_device_id_result()
{
	...
	id_list.count = 2;
	id_list.device_id = (struct _prx_device_id_st *)hm_xml_alloc(id_list.count * sizeof(int));
	...
	hm_xml_dealloc(id_list.device_id, id_list.count * sizeof(int));
	jpf_xml_msg_destroy_2(msg);
	printf("return: %d.buf: %s\n", ret, buf);
...
static void test_get_page_user_response()
{
	...
	page_user.user_info = (struct __UserInfo*)hm_xml_alloc(sizeof(struct __UserInfo)*2);
	...
	ret = create_xml(msg, buf, sizeof(buf), 0);
	hm_xml_dealloc(page_user.user_info, sizeof(struct __UserInfo)*2);
...
static int test_store_log_request()
{
  ...
  store_log_packet = (struct __StoreLogPacket *)hm_xml_alloc(sizeof(struct __StoreLogPacket));   
  ...
  hm_xml_dealloc(store_log_packet, sizeof(struct __StoreLogPacket));
...
static int test_store_log_result()
{
    ...
    store_log_info = (struct __StoreLogPacket *)hm_xml_alloc(sizeof(struct __StoreLogPacket));   
    ...
    hm_xml_dealloc(store_log_info, sizeof(struct __StoreLogPacket));
...
static int test_firmware_upgrade_request()
{
	...
	upgrade_info = (FirmwareUpgradePacket*)hm_xml_alloc(sizeof(FirmwareUpgradePacket));   
	...
	hm_xml_dealloc(upgrade_info, sizeof(FirmwareUpgradePacket));
