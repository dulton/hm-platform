									...
									const char *merge_path, int flags)
{
	...
	request = hm_xml_alloc(sizeof(Request));
								...
								const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	result = hm_xml_alloc(sizeof(Result));
...
static void register_request_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	reg_request = hm_xml_alloc(sizeof(RegisterRequestPacket));
	...
	hm_xml_dealloc(reg_request, sizeof(RegisterRequestPacket));
}
static void register_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	reg_response = hm_xml_alloc(sizeof(RegisterResponsePacket));
	...
	hm_xml_dealloc(reg_response, sizeof(RegisterResponsePacket));
}
static void heart_beat_request_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	heart_beat = hm_xml_alloc(sizeof(HeartBeatRequestPacket));
	...
	hm_xml_dealloc(heart_beat, sizeof(HeartBeatRequestPacket));
}
static void heart_beat_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	heart_beat_resp = hm_xml_alloc(sizeof(HeartBeatResponsePacket));
	...
	hm_xml_dealloc(heart_beat_resp, sizeof(HeartBeatResponsePacket));
}
static void change_dispatch_request_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	change_disp = hm_xml_alloc(sizeof(ChangeDispatchPacket));
	...
	hm_xml_dealloc(change_disp, sizeof(ChangeDispatchPacket));
}
...
static void device_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	dev_info = hm_xml_alloc(sizeof(DeviceInfoPacket));
	...
	hm_xml_dealloc(dev_info, sizeof(DeviceInfoPacket));
}
...
static void device_ntp_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	ntp_info = hm_xml_alloc(sizeof(DeviceNTPInfoPacket));
	...
	hm_xml_dealloc(ntp_info, sizeof(DeviceNTPInfoPacket));
}
...
static void set_device_time_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	dev_time = hm_xml_alloc(sizeof(DeviceTimePacket));
	...
	hm_xml_dealloc(dev_time, sizeof(DeviceTimePacket));
}
...
static void platform_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));	
	pltf_info = hm_xml_alloc(sizeof(PlatformInfoPacket));
	...
	hm_xml_dealloc(pltf_info, sizeof(PlatformInfoPacket));
}
...
static void network_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	net_info = hm_xml_alloc(sizeof(NetworkInfoPacket));
	...
	hm_xml_dealloc(net_info, sizeof(NetworkInfoPacket));
}
...
static void pppoe_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));	
	pppoe_info = hm_xml_alloc(sizeof(PPPOEInfoPacket));
	...
	hm_xml_dealloc(pppoe_info, sizeof(PPPOEInfoPacket));
}
...
static void encode_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	encode_para = hm_xml_alloc(sizeof(EncodeParameterPacket));
	...
	hm_xml_dealloc(encode_para, sizeof(EncodeParameterPacket));
}
...
static void display_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	display_para = hm_xml_alloc(sizeof(DisplayParameterPacket));
	...
	hm_xml_dealloc(display_para, sizeof(DisplayParameterPacket));
}
...
static void record_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	record_para = hm_xml_alloc(sizeof(RecordParameterPacket));
	...
	hm_xml_dealloc(record_para, sizeof(RecordParameterPacket));
}
...
static void hide_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	hide_para = hm_xml_alloc(sizeof(HideParameterPacket));
	...
	hm_xml_dealloc(hide_para, sizeof(HideParameterPacket));
}
...
static void serial_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	serial_para = hm_xml_alloc(sizeof(SerialParameterPacket));
	...
	hm_xml_dealloc(serial_para, sizeof(SerialParameterPacket));
}
...
static void osd_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	osd_para = hm_xml_alloc(sizeof(OSDParameterPacket));
	...
	hm_xml_dealloc(osd_para, sizeof(OSDParameterPacket));
}
...
static void ptz_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	ptz_para = hm_xml_alloc(sizeof(PTZParameterPacket));
	...
	hm_xml_dealloc(ptz_para, sizeof(PTZParameterPacket));
}
...
static void ftp_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	ftp_para = hm_xml_alloc(sizeof(FTPParameterPacket));
	...
	hm_xml_dealloc(ftp_para, sizeof(FTPParameterPacket));
}
...
static void smtp_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	smtp_para = hm_xml_alloc(sizeof(SMTPParameterPacket));
	...
	hm_xml_dealloc(smtp_para, sizeof(SMTPParameterPacket));
}
...
static void upnp_parameter_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	upnp_para = hm_xml_alloc(sizeof(UPNPParameterPacket));
	...
	hm_xml_dealloc(upnp_para, sizeof(UPNPParameterPacket));
}
...
static void disk_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	disk_info = hm_xml_alloc(sizeof(DeviceDiskInfoPacket));
	...
	hm_xml_dealloc(disk_info, sizeof(DeviceDiskInfoPacket));
}
static void format_disk_request_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	format = hm_xml_alloc(sizeof(FormatDiskPacket));
	...
	hm_xml_dealloc(format, sizeof(FormatDiskPacket));
}
...
static void move_alarm_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	move_alarm = hm_xml_alloc(sizeof(MoveAlarmPacket));
	...
	hm_xml_dealloc(move_alarm, sizeof(MoveAlarmPacket));
}
...
static void lost_alarm_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	lost_alarm = hm_xml_alloc(sizeof(LostAlarmPacket));
	...
	hm_xml_dealloc(lost_alarm, sizeof(LostAlarmPacket));
}
...
static void hide_alarm_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	hide_alarm = hm_xml_alloc(sizeof(HideAlarmPacket));
	...
	hm_xml_dealloc(hide_alarm, sizeof(HideAlarmPacket));
}
...
static void io_alarm_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	io_alarm = hm_xml_alloc(sizeof(IoAlarmPacket));
	...
	hm_xml_dealloc(io_alarm, sizeof(IoAlarmPacket));
}
...
static void joint_action_info_response_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	joint_action = hm_xml_alloc(sizeof(JointActionPacket));
	...
	hm_xml_dealloc(joint_action, sizeof(JointActionPacket));
}
...
static void submit_alarm_request_test(const char *parse_path, const char *merge_path, int flags)
{
	...
	memset(buffer, 0, sizeof(buffer));
	sub_alarm = hm_xml_alloc(sizeof(SubmitAlarmPacket));
	...
	hm_xml_dealloc(sub_alarm, sizeof(SubmitAlarmPacket));
}
...
int main()
{
	...
	//xml_tree = (XmlTreeNode*)hm_xml_alloc(sizeof(XmlTreeNode));
	...
	if (0 == xml_tree_parse_by_mxml(xml_tree, buffer))
	{
		...
		hm_xml_dealloc(xml_tree, sizeof(XmlTreeNode));//*/
...
int register_xml_entry(XmlTable *table, xml_id cmd, JCreateXML func_c, JParseXML func_p)
{
	...
	if (table->n_entries >= table->n_capacity)
	{
		...
		entries = hm_xml_alloc(capacity * sizeof(XmlEntry));
		if (entries)
			return -E_NOMEM;
		memcpy(entries, table->entries, table->n_capacity * sizeof(XmlEntry));
		hm_xml_dealloc(table->entries);
